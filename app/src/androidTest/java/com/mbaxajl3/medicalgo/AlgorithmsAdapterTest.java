...
@LargeTest
public class AlgorithmsAdapterTest {
    @Rule
    ...
    public void like() {
        ...
        onView(withId(R.id.algorithms_view)).perform(RecyclerViewActions.actionOnItemAtPosition(0, clickChildViewWithId(R.id.favourite_button)));
